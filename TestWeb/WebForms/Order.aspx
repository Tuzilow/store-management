<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="TestWeb.WebForms.Order" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    function doDelete(id) {
        if (confirm("你真的要删除id为：" + id + "商品信息？")) {
            window.location = "../Handlers/DeleteOrderHandler.ashx?Id=" + id;
        }
    }
</script>
<style>
...
<table class="table table-hover border">
   <thead>
    ...
    <tbody id="adminTbody">
    <forEach items="${user }" var="user">  <%=OrderList %> </forEach>
    </tbody>
 </table>
        <!--分页标签-->
    <div style>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                        action="../Handlers/InsertOrderHandler.ashx"
                        method="POST"
                        id="addForm"
                        accept-charset="UTF-8">
                        <div class="form-group">
                            <label for="pGoodsId" class="col-form-label">商品ID</label>
                            <select name="pGoodsId" class="form-control" id="pGoodsId"> <%=ops %></select>
                           
                        </div>
                        <div class="form-group">
                            <label for="pGoodsCount" class="col-form-label">交易数量</label>
                            <input
                                name="pGoodsCount"
                                type="text"
                                class="form-control"
                         ...
                         <div class="form-group">
                            <label for="pFactoryId" class="col-form-label">供应商</label>
                              <select name="pFactoryId" class="form-control" id="pFactoryId"> <%=oph %></select>
                          
                        </div>
                        <div class="form-group">
                            <label for="pCreateTime" class="col-form-label">订单时间</label>
                            <input
                                name="pCreateTime"
                                type="date"
                                class="form-control"
                         ...
                         <div class="form-group">
                            <label for="pOrderType" class="col-form-label">订单类型</label>
                            <input
                                name="pOrderType"
                                type="text"
                                class="form-control"
                        ...
                        <div class="form-group">
                            <label for="pRemakes" class="col-form-label">备  注</label>
                            <input
                                name="pRemakes"
                                type="text"
                                class="form-control"
